window.CHARACTER_CONFIGS = {
    player: {
        scale: 1.7, headW: 14, headH: 12, headY: -6, torsoW: 13, torsoH: 20,
        upperArmW: 5, upperArmLen: 12, lowerArmW: 4, lowerArmLen: 7,
        upperLegW: 6, upperLegLen: 12, lowerLegW: 5, lowerLegLen: 15,
        shoulderX: 5, shoulderY: -9, hipX: 4, hipY: 8,
        elbowAngle: 0.5, kneeAngle: 0.2,
        shadowAlpha: 0.4,
        cSkin: '#ffdfc4', cHair: '#cbd5e1', cEye: '#38bdf8', cBody: '#334155', cArmorAcc: '#f59e0b',
        cArms: '#475569', cLegs: '#1e293b',
        motions: {
