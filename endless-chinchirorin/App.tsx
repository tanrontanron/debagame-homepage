            ...
            {showStats ? (
                ...
                ${gamePhase === 'DEALER_TURN' ? 'bg-red-950/40 ring-2 ring-red-500/50' : 'bg-stone-900/40'}`}>
                        ...
                        <div className={`flex gap-3 scale-75 ${gamePhase === 'DEALER_TURN' && isRolling ? 'animate-pulse blur-[1px]' : ''}`}>
                            <Die value={dealerDice[0]} rolling={gamePhase === 'DEALER_TURN' && isRolling} />
                            <Die value={dealerDice[1]} rolling={gamePhase === 'DEALER_TURN' && isRolling} />
                            <Die value={dealerDice[2]} rolling={gamePhase === 'DEALER_TURN' && isRolling} />
                 ...
                 ${gamePhase === 'PLAYER_TURN' ? 'ring-4 ring-amber-400/50' : ''}`}>
                        ...
                        <div className={`flex gap-4 z-10 transition-all ${gamePhase === 'PLAYER_TURN' && isRolling ? 'animate-shake blur-[1px]' : ''}`}>
                            <Die value={playerDice[0]} rolling={gamePhase === 'PLAYER_TURN' && isRolling} />
                            <Die value={playerDice[1]} rolling={gamePhase === 'PLAYER_TURN' && isRolling} />
                            <Die value={playerDice[2]} rolling={gamePhase === 'PLAYER_TURN' && isRolling} />
